...
export class CatRenderer {
    ...
    draw(context) {
        ...
        (_a = this.animations[this.size.getDirectionMap()]) === null || _a === void 0 ? void 0 : _a.drawFrame(context.clockTick, ctx, this.movementMgr.getPosition().x, this.movementMgr.getPosition().y, this.size.getScale());
        if (context.debug) {
            ctx.save();
